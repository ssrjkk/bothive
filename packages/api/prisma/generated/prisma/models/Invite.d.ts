...
export type InviteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "email" | "token" | "role" | "createdById" | "usedAt" | "expiresAt" | "createdAt", ExtArgs["result"]["invite"]>;
