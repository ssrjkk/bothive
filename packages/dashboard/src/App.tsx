...
import { DashboardOutlined, RobotOutlined, SettingOutlined, FileTextOutlined, TeamOutlined, ApiOutlined, CodeOutlined, BarChartOutlined } from '@ant-design/icons';
...
const adminKeys = new Set(['/scripts', '/queues', '/webhooks', '/settings']);
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        <Header style={{ background: '#fff', padding: '0 24px', borderBottom: '1px solid #f0f0f0' }}>
          <Typography.Title level={4} style={{ margin: '16px 0' }}>BotHive — Multi-Bot Orchestrator by ssrjkk</Typography.Title>
        </Header>
