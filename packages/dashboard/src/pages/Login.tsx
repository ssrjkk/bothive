      ...
      <div className="bh-login-grid">
        <div className="bh-login-hero">
          ...
          <p className="bh-hero-sub">
            BotHive is the control plane for your multi-platform bot fleet — connect accounts,
            automate behavior, and watch it all live.
          </p>
          {FEATURES.map((f) => (
            <div className="bh-feature" key={f}>
              <span className="bh-feature-check">
                <CheckOutlined />
              </span>
              <span>{f}</span>
            </div>
          ...
          <div style={{ padding: '20px 32px 28px' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: 8 }}>
              <Typography.Text type="secondary" style={{ fontSize: 12 }}>
                <RocketOutlined /> Orchestrate Telegram, Twitch, YouTube &amp; Twitter bots from one
                place.
              </Typography.Text>
            </div>
