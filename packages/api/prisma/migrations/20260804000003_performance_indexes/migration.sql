...
CREATE INDEX IF NOT EXISTS "Bot_platform_status_idx" ON "Bot"("platform", "status");
CREATE INDEX IF NOT EXISTS "Script_botId_trigger_idx" ON "Script"("botId", "trigger");
CREATE INDEX IF NOT EXISTS "Script_enabled_idx" ON "Script"("enabled");
CREATE INDEX IF NOT EXISTS "Webhook_botId_idx" ON "Webhook"("botId");
