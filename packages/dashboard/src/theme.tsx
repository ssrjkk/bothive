...
const lightTokens = {
  ...
  colorBgSpotlight: '#2a2f4a',
  colorTextBase: '#1f2437',
  colorLink: BRAND.primary,
  colorLinkHover: '#9b6bff',
...
const darkTokens = {
  ...
  colorBgElevated: '#1a1e35',
  colorBgSpotlight: '#232841',
  colorTextBase: '#e7e9f7',
  colorLink: BRAND.primaryDark,
  colorLinkHover: '#a69bff',
      ...
      <ConfigProvider
        theme={{
          ...
          components: {
            ...
            Message: {
              contentBg: theme === 'dark' ? '#1a1e35' : '#ffffff',
              borderRadiusLG: 12,
            },
            Modal: {
              contentBg: theme === 'dark' ? '#171a33' : '#ffffff',
              headerBg: theme === 'dark' ? '#171a33' : '#ffffff',
              titleFontSize: 16,
              borderRadiusLG: 16,
            },
            Statistic: {
            ...
            Segmented: {
              itemSelectedBg: theme === 'dark' ? 'rgba(255,255,255,0.1)' : '#ffffff',
            },
            Tabs: {
              titleFontSize: 14,
